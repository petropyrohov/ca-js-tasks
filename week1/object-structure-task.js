...
{
  const result = obj.f[0].a[2] + obj.y + obj.c[1] + obj.y + obj.y + obj.f[1].l + obj.y + obj.l + obj.y + obj.e.d + obj.c[2].k;
  console.log(result);
  console.log(obj.f[0].a[2]);
  console.log(obj.c[1]);
  console.log(obj.f[1].l)
  console.log(obj.l)
  console.log(obj.e.d)
...
console.group('šiandien visai geras oras!');
{
  ...
  console.log(result);
  console.log(obj.f[0].a[0])
  console.log(obj.f[0].a[3])
  console.log(obj.e.a[0].a)
  console.log(obj.f[1].a.u)
  console.log(obj.c[2].t)
...
console.group('galbūt gera proga susitikti?');
{
  ...
  console.log(result);
  console.log(obj.e.a[0].v)
  console.log(obj.f[0].a[1])
  console.log(obj.a.g)
  console.log(obj.e.a[0].p[0])
  console.log(obj.f[1].a.o[0])
}
console.groupEnd();